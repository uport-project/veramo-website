...
Represents a WHERE predicate for a [FindArgs](./core.findargs.md) query. In situations where multiple WHERE predicates are present, they are combined with AND.
