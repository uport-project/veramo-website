...
| [save?](./core-types.icreateverifiablecredentialargs.save.md)                                 |           | boolean                                                | _(Optional)_ If this parameter is true, the resulting VerifiablePresentation is sent to the [storage plugin](./core-types.idatastore.md) to be saved.                                                                                                                                                                                                                       |
