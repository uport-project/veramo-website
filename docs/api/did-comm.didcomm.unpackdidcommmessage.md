...
| context   | IAgentContext&lt;IDIDManager &amp; IKeyManager &amp; IResolver &amp; IMessageHandler&gt; | This method requires an agent that also has , and plugins in use. When calling this method, the <code>context</code> is supplied automatically by the framework. |
