...
This is used internally by [DataStoreJson](./data-store-json.datastorejson.md) to represent a Verifiable Credential in a way that facilitates querying using the interface.
...
| ------------------------------------------------------------------------------------ | --------- | ----------------------- | -------------------------------------- |
| [canonicalCredential](./data-store-json.credentialtableentry.canonicalcredential.md) |           | W3CVerifiableCredential | <b><i>(BETA)</i></b>                   |
...
| [parsedCredential](./data-store-json.credentialtableentry.parsedcredential.md)       |           | VerifiableCredential    | <b><i>(BETA)</i></b>                   |
