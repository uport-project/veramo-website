    ...
    <section>
      <div className={'section tooling'} style={{backgroundColor: 'white'}}>
        <div className={'container'} style={{display: 'flex', flexDirection: 'row'}}>
          <div className={'column left'} style={{display: 'flex', flex: 1, justifyContent: 'flex-end', padding: 50}}>
          ...
          <div className={'column right'} style={{flex: 1, padding: 50}}>
            <div className={'content'}>
              <h3 className={'promoTitle'} style={{fontSize: 24}}>Orchestrate standards and build trust layers into your apps</h3>
              <p className={'promoText'} style={{fontSize: 18}}>{textContent.orchestrateStandards}</p>
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    <section>
      <div className={'section tooling'} style={{backgroundColor: 'whitesmoke'}}>
        <div className={'container'} style={{display: 'flex', flexDirection: 'row'}}>
          <div className={'column left'} style={{display: 'flex', flex: 1, justifyContent: 'flex-end', padding: '50px 20px 0 0'}}>
            <div className={'content'}>
              <h3 className={'promoTitle'} style={{fontSize: 24}}>Modular, composable, scalable</h3>
              <p className={'promoText'} style={{fontSize: 18}}>{textContent.tooling}</p>
            </div>
          </div>
  ...
  return (
    <section>
      <div className={'section tooling container'} style={{display: 'flex', flexDirection: 'row',}}>
        ...
        <div className={'column right'} style={{flex: 1, padding: 50}}>
          <div className={'content'}>
            <h3 className={'promoTitle'} style={{fontSize: 24}}>Multi-Platform out of the box</h3>
              <p className={'promoText'} style={{fontSize: 18}}>{textContent.multiPlatform}</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section>
      <div className={'section tooling'} style={{backgroundColor: 'whitesmoke'}}>
        <div className={'container'} style={{display: 'flex', flexDirection: 'row'}}>
          <div className={'column left'} style={{display: 'flex', flex: 1, justifyContent: 'flex-end', padding: '50px 20px 0 0'}}>
            <div className={'content'}>
              <h3 className={'promoTitle'} style={{fontSize: 24}}>Awesome CLI</h3>
              <p className={'promoText'} style={{fontSize: 18}}>{textContent.awesomeCLI}</p>
            </div>
          </div>
          <div className={'column right'} style={{flex: 1}}>
      ...
      <header className={clsx('hero hero--primary', styles.heroBanner)}>
        <div className="container">
          ...
          <div className={styles.buttons}>
            ...
            <Link
              className={clsx(
                'button  button--lg button--no-border',
                styles.learnMore,
              )}
              to={useBaseUrl('docs/fundamentals/introduction')}>
              Learn more
